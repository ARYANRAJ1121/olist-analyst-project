...
-- @block 3. Average Order Value (AOV) by month
SELECT
    DATE_TRUNC('month', o.order_purchase_timestamp) AS month,
...
-- @block 4. Monthly active customers
SELECT
    DATE_TRUNC('month', order_purchase_timestamp) AS month,
...
-- @block 5. Revenue per active customer (monetization quality)
SELECT
    DATE_TRUNC('month', o.order_purchase_timestamp) AS month,
